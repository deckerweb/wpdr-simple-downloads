...
if ( ! is_user_logged_in() ) {
	...
	wp_die(
		__( 'You must be logged in to run this script.', 'wpdr-simple-downloads' ),
...
if ( ! current_user_can( 'install_plugins' ) ) {
	...
	wp_die(
		__( 'You do not have permission to run this script.', 'wpdr-simple-downloads' ),
		__( 'WP Document Revisions Simple Downloads', 'wpdr-simple-downloads' ),
		array( 'back_link' => TRUE )
	);
 ...
 * @uses  delete_option()
 */
function ddw_wpdrsd_delete_options() {

	/** Delete all options */
	delete_option( 'wpdrsd_options' );
 ...
 *
 * @uses   ddw_wpdrsd_delete_options()
 *
 * @param  array $blogs
 * @param  int 	 $blog
 *
